...
export const WARDS: WardInfo[] = [
  { id: '13101', name: '千代田区', slug: 'chiyoda',   catch: '昼だけ人口20倍、夜は静寂を愛す二面性エリート', color: '#cdd3e8', geo: { x: 0.0,  y: 0.0 } },
  ...
  { id: '13114', name: '中野区',   slug: null,        catch: 'サブカルに生きる自由な一人暮らし玄人',         color: '#8f8f98', geo: { x: -1.5, y: 0.15 } },
  { id: '13115', name: '杉並区',   slug: null,        catch: '静かな住宅街で趣味に浸る文化系',               color: '#8a8f56', geo: { x: -2.1, y: 0.0 } },
  { id: '13116', name: '豊島区',   slug: null,        catch: '密度MAXの都会っ子、公園ゼロでも元気',          color: '#e8c832', geo: { x: -0.75, y: 0.75 } },
  { id: '13117', name: '北区',     slug: null,        catch: '昭和の風情を守る人情深いおばあちゃん子',       color: '#a85040', geo: { x: -0.25, y: 1.3 } },
  { id: '13118', name: '荒川区',   slug: null,        catch: 'つつましくも家族思い、路面電車の走る街',       color: '#e0cb96', geo: { x: 0.45, y: 1.05 } },
  { id: '13119', name: '板橋区',   slug: null,        catch: '庶民派の頼れる姐さん、実は成熟した落ち着き',   color: '#54705e', geo: { x: -1.05, y: 1.35 } },
  { id: '13120', name: '練馬区',   slug: null,        catch: 'アニメと畑のファミリー長女、面倒見抜群',       color: '#9fc84a', geo: { x: -1.9, y: 0.95 } },
  { id: '13121', name: '足立区',   slug: null,        catch: '気は優しくて力持ち、成熟した下町の姐御',       color: '#e07030', geo: { x: 0.75, y: 1.7 } },
  { id: '13122', name: '葛飾区',   slug: null,        catch: '人情と家族の絆No.1、寅さん気質',               color: '#9a6a44', geo: { x: 1.5,  y: 1.15 } },
  { id: '13123', name: '江戸川区', slug: null,        catch: '公園面積1位の圧倒的みどり、大家族の末っ子ガキ大将', color: '#4ac850', geo: { x: 1.85, y: 0.15 } },
];
