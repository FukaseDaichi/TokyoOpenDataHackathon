...
export const WARDS: WardInfo[] = [
  ...
  { id: '13116', name: '豊島区',   slug: 'toshima',   catch: '密度MAXの都会っ子、公園ゼロでも元気',          color: '#e8c832', geo: { x: -0.75, y: 0.75 } },
  ...
  { id: '13122', name: '葛飾区',   slug: 'katsushika', catch: '人情と家族の絆No.1、寅さん気質',              color: '#9a6a44', geo: { x: 1.5,  y: 1.15 } },
